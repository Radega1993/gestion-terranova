...
interface LiquidacionSuplementosProps {
    suplementosList: Suplemento[];
    selectedSuplementos: { id: string; cantidad?: number }[];
    onSuplementoChange: (suplementoId: string, checked: boolean) => void;
    onCantidadChange: (suplementoId: string, cantidad: number) => void;
}

export const LiquidacionSuplementos: React.FC<LiquidacionSuplementosProps> = ({
    suplementosList,
    selectedSuplementos,
    onSuplementoChange,
    onCantidadChange,
